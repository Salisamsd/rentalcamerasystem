...
require '../index.php';
$rentID = $_GET['rentID'];
$qq = "select * from rentlist LEFT JOIN statusR ON rentlist.status= statusR.id where rentID='$rentID'";
    ...
    <div class="container-fluid" >
        ...
        <div class="w3-row">
            <table border="1" class="table table-striped table-bordered table-hover" >
                ...
                <tr><td>ผู้เช่า </td><td> <?php echo $rowitem['username']; ?> </td> </tr>
				<tr><td>สถานะ </td><td> <?php echo $rowitem['statusR_name']; ?> </td> </tr>
            </table>

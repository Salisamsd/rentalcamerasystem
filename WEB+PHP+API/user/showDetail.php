...
require '../index.php';
$Id = $_GET['Id'];
$qq = "select * from users LEFT JOIN userimg1 ON users.username=userimg1.username where Id='$Id'";
    ...
    <div class="container-fluid" >
        ...
        <div class="w3-row">
            <table border="1" class="table table-striped table-bordered table-hover" >
                ...
                <tr><td>ลำดับที่</td><td><?php echo $rowitem['Id']; ?></td></tr>
                <tr><td>username</td><td><?php echo $rowitem['username']; ?></td></tr>
                <tr><td>ชื่อจริง</td><td ><?php echo$rowitem['name']; ?></td></tr>
                <tr><td>นามสกุล</td><td><?php echo $rowitem['lastname']; ?></td></tr>
                <tr><td>วัน-เดือน-ปีเกิด</td><td><?php echo $rowitem['bdate']; ?></td></tr>
                <tr><td>บัตรประชาชน</td><td><?php echo $rowitem['nationID']; ?></td></tr>
                <tr><td>ที่อยู่ </td><td> <?php echo $rowitem['address']; ?> 
                <tr><td>E-mail</td><td> <?php echo $rowitem['email']; ?> 
                <tr><td>เบอร์โทรศัพท์</td><td> <?php echo $rowitem['telephone']; ?> 
                    </td> 
                </tr> 
            </table>

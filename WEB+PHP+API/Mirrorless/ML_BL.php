...
<table border="1" class="table table-striped table-bordered table-hover" >
            ...
            <tr>
                ...
                <td><a class="btn btn-warning " href="updatemlBL.php?item_id=<?php echo ($row['item_id']) ;?>">แก้ไข</td>
                <td><a class="btn btn-danger " href="deletemlBL.php?item_id=<?php echo ($row['item_id']) ;?>">ลบ</td>
            </tr>
            <?php
                }
